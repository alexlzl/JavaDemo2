...
/**
 * File.pathSeparator=":" File.pathSeparatorChar=":" File.separator="/"
 * File.separatorChar="/" s1_normal.exists() = true s1_normal.getName() =
 * s1_normal.txt s1_normal.getParent() = dir/sub1 s1_normal.getPath() =
 * dir/sub1/s1_normal.txt s1_normal.getAbsolutePath() =
 * /DEVELOP/Eclipse_WORKSPACE/文件/dir/sub1/s1_normal.txt
 * s1_normal.getCanonicalPath() =
 * /DEVELOP/Eclipse_WORKSPACE/文件/dir/sub1/s1_normal.txt s1_normal.lastModified()
 * = 1487745503000 is "2017-02-22 14:38:23" s1_normal.toURI() =
 * file:/DEVELOP/Eclipse_WORKSPACE/文件/dir/sub1/s1_normal.txt ---- list files and
 * folders ---- .l1_hide.txt [File][Hidden] file1.txt [File] l1_abs.txt [File]
 * l1_normal.txt [File] l1_uri.txt [File] sub1 [Directory] sub2 [Directory] sub3
 * [Directory] sub4 [Directory] sub5 [Directory]
 * 
 * @author lzl
 *
 */
public class FileTest {
	...
	public static void testFileDirAPIS() {
		try {
			...
			sub2.mkdir();
			// 方法3：新建目录 "dir9/sub9"。mkdirs()会自动创建不存在的父目录。
			File sub3 = new File("dir9/sub8");
//			sub3.renameTo(sub3);
			sub3.mkdirs();
			File r = new File("dir9/rename");
			sub3.renameTo(r);
			...
			System.out.println("===="+uri_sub5_path);//file:/DEVELOP/Eclipse_WORKSPACE/文件/dir/sub5
